...
export type AssetsCheckType = "apply" | "dispose";

export interface AssetsCheckModalProps {
  title: string;
  loading?: boolean;
  applyId: string;
...
const AssetsCheckModal: FC<AssetsCheckModalProps> = (props) => {
...
export default observer(AssetsCheckModal);
