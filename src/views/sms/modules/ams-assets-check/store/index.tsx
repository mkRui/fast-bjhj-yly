...
export class AssetsCheckStore extends Store<Api> {
  ...
  public async disposeCheck(params: API.DisposeCheck.Params) {
    const [err] = await this.api.disposeCheck(params);
    return resolveMutation(err, () => this.getList());
  }
}

const StoreContext = createContext<AssetsCheckStore>({} as AssetsCheckStore);
