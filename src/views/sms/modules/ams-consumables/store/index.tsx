...
export class AmsConsumablesStore extends Store<Api> {
  ...
  public async stockIn(params: API.StockIn.Params): Promise<boolean> {
    this.$setLoading(true);
...
const StoreContext = createContext<AmsConsumablesStore>({} as AmsConsumablesStore);
